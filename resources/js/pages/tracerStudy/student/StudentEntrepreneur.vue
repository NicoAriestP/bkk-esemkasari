...
const businessScaleOptions = computed(() => props.entrepreneurOptions?.businessScaleOptions || []);
const businessIncomeOptions = computed(() => props.entrepreneurOptions?.businessIncomeOptions || []);
</script>
