...
use App\Exports\Student\TracerStudyExport;
...
class StudentController extends Controller
{
    ...
    public function exportTracerStudy(Year $year, StudentClass $studentClass)
    {
        return (new TracerStudyExport($studentClass, true))
